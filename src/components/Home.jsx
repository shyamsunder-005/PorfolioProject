...
//         <Space wrap size={16}>
//           <Avatar shape="square" src={dpImage} size={150} icon={<UserOutlined />} />
//         </Space>
//       </div>
...
//         <Typography variant="body1" sx={{ textAlign: 'left', margin: '50px 0 0 0' }}  >
...
function Home() {
  return (
      <div className="mainContainer-2">
          <div className="profile-section">
              <Space wrap size={16}>
                  <Avatar shape="square" src={dpImage} size={300} icon={<UserOutlined />} />
              </Space>
          </div>
          <div className="text-section">
